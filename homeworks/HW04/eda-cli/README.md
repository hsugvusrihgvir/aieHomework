...
К существующему CLI-приложению для EDA добавлен **HTTP-сервис на FastAPI** с эндпоинтами `/health`, `/quality` и `/quality-from-csv`, `/quality-flags-from-csv`.  
...
### 5. `POST /quality-flags-from-csv` – полный набор флагов качества по CSV (HW03)

Эндпоинт принимает CSV-файл аналогично `/quality-from-csv` и возвращает только набор булевых флагов качества (включая добавленные в HW03).
